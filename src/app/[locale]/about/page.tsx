  ...
  return (
    <>
      ...
      <section className="py-20 px-8 bg-surface-container-low">
        <div className="max-w-[2560px] mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <div>
        ...
        <div className="max-w-[2560px] mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              <div key={value.icon} className="glass-card p-10 rounded-lg border border-outline-variant/10 hover:border-primary/30 transition-all">
