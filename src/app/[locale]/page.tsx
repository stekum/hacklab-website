...
export default async function HomePage({
  ...
  return (
    <>
      {/* Hero Section */}
      <section className="relative pt-40 pb-32 px-8 min-h-screen flex items-center overflow-hidden grid-overlay">
        <div className="max-w-[2560px] mx-auto grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
          <div className="z-10">
      ...
      <section className="bg-surface-container-lowest py-24 px-8 border-y border-outline-variant/10">
        <div className="max-w-[2560px] mx-auto flex flex-col md:flex-row justify-between items-start gap-12">
        ...
        <div className="max-w-[2560px] mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              <div
                key={pillar.icon}
                className="glass-card p-12 rounded-lg border border-outline-variant/10 hover:border-primary/30 transition-all group"
              >
      ...
      <section className="py-32 px-8 bg-surface-container-low">
        <div className="max-w-[2560px] mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-6">
            {/* Hero Service Card */}
            <div className="md:col-span-8 glass-card p-12 rounded-lg border border-outline-variant/10 flex flex-col justify-between min-h-[500px] overflow-hidden relative">
            ...
            <div className="md:col-span-4 glass-card p-10 rounded-lg border border-outline-variant/10">
          ...
          <div className="relative">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-16 relative z-10">
              {[
                ...
                <div key={step.icon} className="text-center group">
