    ...
    <>
      ...
      <section className="py-24 px-8 relative">
        ...
        <div className="max-w-7xl mx-auto space-y-12">
          {[
            { icon: "architecture", title: t("platform_title"), desc: t("platform_desc"), items: ["Databricks & Microsoft Fabric", "Cloud Migration (Azure/AWS)", "Data Governance Frameworks"], image: "https://lh3.googleusercontent.com/aida-public/AB6AXuC8zlhMR2QgbqN9M9Pc6ib8AjRQjJi1kFvi6gocLaj74CRUSYkQBpcTHkdnQtTV5sDJT1Qh6EzXT5dkdEXK8rKpViMSGKKgKdT6wUogoV7AbROtNA5WeBe_6Lh1Zy9rRfEFZa5MHO5A-DKj0J7KtRgn5lBGzQh0pAhXygjxBOAG1pncVPvZcO1zpmGUvhXNKHCvUDXzxt-UNoPAoWbZsJjK3vv1kqNVOI0HO6Kg-9JTo36kREB2zhR3qKpeTVWTzXNypT1JL_8fwLSo", imageAlt: "Laptop with architecture diagram" },
            ...
            { icon: "eco", title: t("sustainability_title"), desc: t("sustainability_desc"), items: ["Carbon Footprint Engine", "Supply Chain Transparency", "EU Taxonomy Compliance"], image: "https://lh3.googleusercontent.com/aida-public/AB6AXuBQxnccQDNBx0PFxnKQkP1ebsdveJ2ngWPJevXA2ZAfKYmqTv1HLtX80P7Q2LtzgbnqbNDsTDM6mlhtoUW1TUvjQwvPu_M5tWhahCBNk2TFQK6G_nq0H23Dzr--cIhPO-Z5F2TFyEpoowBG55Fz0GqM0_QhCbm81mQHyWVSrzme6FPfJDF9QmGRq3n_cNg4-AXDfpyXOWNwPJC9eJpZAzn-U6mI0IyPf_4oL74PkfRGDSOS0rAml7OeWDfg5yslqk-4NbprE0N7BTSv", imageAlt: "Automotive production line" },
          ].map((service, index) => (
